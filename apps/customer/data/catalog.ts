...
export type CategoryKey = 'comida' | 'mercado' | 'farmacia' | 'tiendas' | 'envios'
export type BusinessType = 'restaurant' | 'grocery' | 'pharmacy' | 'fashion' | 'footwear' | 'electronics' | 'courier'
export type ProductStatus = 'draft' | 'published' | 'paused' | 'out_of_stock' | 'archived'
export type ProductOption = { label: string; price: number }
export type ProductVariant = { id: string; label: string; stock: number; priceDelta?: number }
export type Product = {
  id: number
  name: string
  description: string
...
export const categories: CategoryMeta[] = [
  ...
  { key: 'tiendas', label: 'Tiendas', symbol: 'T', tagline: 'Moda, calzado y tecnología', tone: 'red', heroTitle: 'ENCUENTRA\nTU ESTILO.', searchPlaceholder: 'Buscar moda, calzado o tecnología', storeSection: 'TIENDAS DESTACADAS', catalogLabel: 'COLECCIONES Y PRODUCTOS', purity: 'Moda, calzado, electrónica, belleza y hogar con variantes propias.' },
...
export const stores: Store[] = [
  { id: 1, name: 'Barrio Burger', descriptor: 'Smash burgers · papas · shakes', category: 'comida', businessType: 'restaurant', eta: '18–24 min', rating: 4.8, delivery: 4.9, minimum: 15, tone: 'red', symbol: 'BB', featured: 'DOBLE / CRUJIENTE / AHORA', products: [
  ...
  { id: 2, name: 'Casa Wok', descriptor: 'Woks · arroces · noodles', category: 'comida', businessType: 'restaurant', eta: '22–30 min', rating: 4.7, delivery: 4.9, minimum: 15, tone: 'yellow', symbol: 'CW', featured: 'WOK / FUEGO / SABOR', products: [
  ...
  { id: 3, name: 'Pizza 33', descriptor: 'Pizzas · entradas · postres', category: 'comida', businessType: 'restaurant', eta: '24–32 min', rating: 4.8, delivery: 5.5, minimum: 18, tone: 'blue', symbol: '33', featured: 'HORNO / QUESO / 33', products: [
  ...
  { id: 4, name: 'Mercado 24', descriptor: 'Abarrotes · frescos · hogar', category: 'mercado', businessType: 'grocery', eta: '25–35 min', rating: 4.6, delivery: 5.9, minimum: 20, tone: 'yellow', symbol: 'M24', featured: 'FRESCO / RÁPIDO / COMPLETO', products: [
  ...
  { id: 5, name: 'Fresco', descriptor: 'Frutas · verduras · lácteos', category: 'mercado', businessType: 'grocery', eta: '20–28 min', rating: 4.8, delivery: 4.5, minimum: 18, tone: 'mint', symbol: 'FR', featured: 'COSECHA / COLOR / FRESCO', products: [
  ...
  { id: 6, name: 'Bodega Norte', descriptor: 'Abarrotes · bebidas · snacks', category: 'mercado', businessType: 'grocery', eta: '18–25 min', rating: 4.5, delivery: 3.9, minimum: 12, tone: 'red', symbol: 'BN', featured: 'BARRIO / DESPENSA / HOY', products: [
  ...
  { id: 7, name: 'Farma Central', descriptor: 'Cuidado · bienestar · primeros auxilios', category: 'farmacia', businessType: 'pharmacy', eta: '16–22 min', rating: 4.9, delivery: 3.9, minimum: 10, tone: 'blue', symbol: '+', featured: 'CUIDADO / CERCA / SEGURO', products: [
  ...
  { id: 8, name: 'Vita', descriptor: 'Higiene · bebé · salud oral', category: 'farmacia', businessType: 'pharmacy', eta: '18–25 min', rating: 4.7, delivery: 4.2, minimum: 10, tone: 'mint', symbol: 'V', featured: 'VITA / CUIDADO / DIARIO', products: [
  ...
  { id: 9, name: 'Botica 7', descriptor: 'Botiquín · higiene · bienestar', category: 'farmacia', businessType: 'pharmacy', eta: '14–20 min', rating: 4.6, delivery: 3.5, minimum: 8, tone: 'yellow', symbol: 'B7', featured: 'BOTICA / BARRIO / 7', products: [
  ...
  { id: 10, name: 'DA Express', descriptor: 'Documentos · sobres · paquetes', category: 'envios', businessType: 'courier', eta: 'Recojo en 15 min', rating: 4.9, delivery: 0, minimum: 0, tone: 'mint', symbol: 'DA', featured: 'RECOGE / MUEVE / ENTREGA', products: [
  ...
  { id: 11, name: 'Ruta Local', descriptor: 'Rutas programadas · multi-entrega', category: 'envios', businessType: 'courier', eta: 'Recojo en 25 min', rating: 4.7, delivery: 0, minimum: 0, tone: 'yellow', symbol: 'RL', featured: 'RUTA / AGENDA / ENTREGA', products: [
  ...
  { id: 12, name: 'Flash Box', descriptor: 'Paquetería rápida · entrega directa', category: 'envios', businessType: 'courier', eta: 'Recojo en 20 min', rating: 4.6, delivery: 0, minimum: 0, tone: 'red', symbol: 'FB', featured: 'FLASH / BOX / AHORA', products: [
  ...
  { id: 13, name: 'Modo Urbano', descriptor: 'Moda · colecciones · accesorios', category: 'tiendas', businessType: 'fashion', eta: '30–45 min', rating: 4.7, delivery: 6.9, minimum: 25, tone: 'red', symbol: 'MU', featured: 'MODA / COLOR / ESTILO', products: [
    { id: 1301, name: 'Polo Essential', description: 'Algodón suave, corte regular y colores urbanos.', price: 39.9, symbol: 'PE', group: 'Polos', popular: true, brand: 'Modo Urbano', presentation: 'Prenda', tags: ['polo','moda','algodón'], variants: [{ id: 's-negro', label: 'S · Negro', stock: 8 }, { id: 'm-negro', label: 'M · Negro', stock: 12 }, { id: 'l-blanco', label: 'L · Blanco', stock: 6 }], attributes: { material: 'Algodón', colección: 'Essential' } },
    { id: 1302, name: 'Casaca Street', description: 'Casaca ligera con cierre y bolsillos frontales.', price: 99.9, symbol: 'CS', group: 'Casacas', brand: 'Modo Urbano', presentation: 'Prenda', tags: ['casaca','street'], variants: [{ id: 'm-azul', label: 'M · Azul', stock: 5 }, { id: 'l-negro', label: 'L · Negro', stock: 4 }], attributes: { material: 'Nylon', temporada: 'Media estación' } },
    { id: 1303, name: 'Bolso Compacto', description: 'Bolso urbano con correa ajustable.', price: 54.9, symbol: 'BC', group: 'Accesorios', brand: 'Modo Urbano', presentation: 'Unidad', tags: ['bolso','accesorio'], variants: [{ id: 'negro', label: 'Negro', stock: 10 }, { id: 'arena', label: 'Arena', stock: 7 }] },
  ]},
  { id: 14, name: 'Urban Step', descriptor: 'Zapatillas · tallas · colecciones', category: 'tiendas', businessType: 'footwear', eta: '35–50 min', rating: 4.8, delivery: 7.5, minimum: 30, tone: 'yellow', symbol: 'US', featured: 'PASO / CALLE / CONFORT', products: [
    { id: 1401, name: 'Runner One', description: 'Zapatilla urbana ligera con suela flexible.', price: 139.9, symbol: 'R1', group: 'Zapatillas', popular: true, brand: 'Urban Step', presentation: 'Par', tags: ['zapatillas','runner'], variants: [{ id: '39-negro', label: '39 · Negro', stock: 5 }, { id: '40-negro', label: '40 · Negro', stock: 8 }, { id: '41-blanco', label: '41 · Blanco', stock: 4 }], attributes: { material: 'Malla técnica', guía: 'Talla regular' } },
    { id: 1402, name: 'Street High', description: 'Zapatilla de caña alta con soporte acolchado.', price: 169.9, symbol: 'SH', group: 'Zapatillas', brand: 'Urban Step', presentation: 'Par', tags: ['zapatillas','caña alta'], variants: [{ id: '38-blanco', label: '38 · Blanco', stock: 4 }, { id: '40-negro', label: '40 · Negro', stock: 6 }, { id: '42-negro', label: '42 · Negro', stock: 3 }], attributes: { material: 'Sintético', guía: 'Talla regular' } },
    { id: 1403, name: 'Sandalia Move', description: 'Sandalia liviana con plantilla anatómica.', price: 69.9, symbol: 'SM', group: 'Sandalias', brand: 'Urban Step', presentation: 'Par', tags: ['sandalia','confort'], variants: [{ id: '37-arena', label: '37 · Arena', stock: 5 }, { id: '39-negro', label: '39 · Negro', stock: 8 }] },
  ]},
  { id: 15, name: 'Tecno Point', descriptor: 'Celulares · accesorios · tecnología', category: 'tiendas', businessType: 'electronics', eta: '35–55 min', rating: 4.7, delivery: 8.5, minimum: 40, tone: 'blue', symbol: 'TP', featured: 'TECNO / GARANTÍA / HOY', products: [
    { id: 1501, name: 'Smartphone Nova 128', description: 'Pantalla 6.6 pulgadas, 128 GB y cámara dual.', price: 699.9, symbol: 'N128', group: 'Celulares', popular: true, brand: 'Nova', presentation: 'Equipo sellado', tags: ['celular','smartphone','128gb'], variants: [{ id: '128-negro', label: '128 GB · Negro', stock: 6 }, { id: '128-azul', label: '128 GB · Azul', stock: 4 }], attributes: { garantía: '12 meses', memoria: '128 GB', pantalla: '6.6 pulgadas' } },
    { id: 1502, name: 'Audífonos Air Beat', description: 'Audífonos inalámbricos con estuche de carga.', price: 119.9, symbol: 'AB', group: 'Audio', brand: 'Air Beat', presentation: 'Caja sellada', tags: ['audífonos','bluetooth'], variants: [{ id: 'blanco', label: 'Blanco', stock: 12 }, { id: 'negro', label: 'Negro', stock: 9 }], attributes: { garantía: '6 meses', conexión: 'Bluetooth' } },
    { id: 1503, name: 'Cargador USB-C 30W', description: 'Carga rápida con cable USB-C incluido.', price: 69.9, symbol: '30W', group: 'Accesorios', brand: 'Volt', presentation: 'Caja', tags: ['cargador','usb-c'], attributes: { garantía: '6 meses', potencia: '30 W' } },
  ]},
]
...
export const promos = [
  ...
  { code: 'TIENDA7', title: 'S/ 7 en tiendas', detail: 'Solo moda, calzado, electrónica y hogar', tone: 'red' as Tone, category: 'tiendas' as CategoryKey },
...
export type BusinessTemplateMeta = {
  type: BusinessType
  label: string
  catalogTitle: string
  ...
  accent: Tone
  customerMode: 'menu' | 'aisles' | 'care' | 'collection' | 'sizes' | 'specs' | 'services'
}

export const businessTemplates: Record<BusinessType, BusinessTemplateMeta> = {
  restaurant: { type: 'restaurant', label: 'Restaurante', catalogTitle: 'MENÚ DEL LOCAL', catalogSubtitle: 'Platos, combos, bebidas y preparación.', groupLabel: 'SECCIÓN DEL MENÚ', primaryField: 'Tiempo de preparación', secondaryField: 'Modificadores', accent: 'red', customerMode: 'menu' },
  grocery: { type: 'grocery', label: 'Mercado y bodega', catalogTitle: 'DESPENSA E INVENTARIO', catalogSubtitle: 'Unidades, peso, marcas, frescos y reemplazos.', groupLabel: 'PASILLO O FAMILIA', primaryField: 'Unidad o peso', secondaryField: 'Marca', accent: 'yellow', customerMode: 'aisles' },
  pharmacy: { type: 'pharmacy', label: 'Farmacia', catalogTitle: 'CUIDADO Y PRESENTACIONES', catalogSubtitle: 'Marca, presentación, bienestar y cuidado personal.', groupLabel: 'ÁREA DE CUIDADO', primaryField: 'Presentación', secondaryField: 'Marca', accent: 'blue', customerMode: 'care' },
  fashion: { type: 'fashion', label: 'Moda', catalogTitle: 'COLECCIONES Y PRENDAS', catalogSubtitle: 'Tallas, colores, materiales y temporadas.', groupLabel: 'COLECCIÓN', primaryField: 'Tallas y colores', secondaryField: 'Material', accent: 'red', customerMode: 'collection' },
  footwear: { type: 'footwear', label: 'Calzado', catalogTitle: 'MODELOS Y TALLAS', catalogSubtitle: 'Stock por talla, color y guía de medidas.', groupLabel: 'TIPO DE CALZADO', primaryField: 'Tallas disponibles', secondaryField: 'Material', accent: 'yellow', customerMode: 'sizes' },
  electronics: { type: 'electronics', label: 'Electrónica', catalogTitle: 'MODELOS Y ESPECIFICACIONES', catalogSubtitle: 'Marca, memoria, variantes, garantía y ficha técnica.', groupLabel: 'FAMILIA TÉCNICA', primaryField: 'Modelo y memoria', secondaryField: 'Garantía', accent: 'blue', customerMode: 'specs' },
  courier: { type: 'courier', label: 'Mensajería', catalogTitle: 'SERVICIOS DE ENTREGA', catalogSubtitle: 'Peso, dimensiones, piezas y cobertura.', groupLabel: 'TIPO DE SERVICIO', primaryField: 'Capacidad', secondaryField: 'Cobertura', accent: 'mint', customerMode: 'services' },
}

export const templateForStore = (store: Store): BusinessTemplateMeta => businessTemplates[store.businessType]
