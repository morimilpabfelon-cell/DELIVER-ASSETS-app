...
export default function DataCenter() {
  ...
  return <SafeAreaView style={styles.safe} edges={['top','bottom']}><Header title="DATOS Y SINCRONIZACIÓN" kicker="ARQUITECTURA CUSTOMER · V2.6" onBack={() => router.back()}/><ScrollView contentContainerStyle={styles.content}>
