...
export default function Account(){
  ...
  return <SafeAreaView style={styles.safe} edges={['top']}><ScrollView contentContainerStyle={styles.content}>
    ...
    <Pressable onPress={()=>Alert.alert('DELIVER ASSETS','App Cliente v2.6 · catálogo visual conectado con Business.')} style={styles.version}><Text style={styles.versionTitle}>DELIVER ASSETS APP</Text><Text style={styles.versionText}>V2.6.0 · ANDROID DEVELOPMENT BUILD</Text></Pressable>
