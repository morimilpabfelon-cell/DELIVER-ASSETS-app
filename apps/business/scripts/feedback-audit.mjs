...
check('permisos explicados antes de Android',profile.includes('Elegir logo')&&profile.includes('Fotografiar el local')&&product.includes("title: 'Elegir foto'")&&product.includes('Fotografiar producto'))
