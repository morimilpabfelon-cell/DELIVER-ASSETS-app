...
const APP_ROLE: AppRole = 'negocio'
const APP_HOME = '/business' as const
...
export default function Auth() {
  ...
  return <SafeAreaView style={styles.safe} edges={['top','bottom']}>
    <Header title="DELIVER ID" kicker="ACCESO EXCLUSIVO · NEGOCIO" onBack={stage === 'verify' ? () => setStage('login') : undefined}/>
