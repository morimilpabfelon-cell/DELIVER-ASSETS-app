...
if (-not (Test-Path (Join-Path $Root "node_modules\expo\package.json"))) {
  Write-Host "Instalando dependencias de Control..." -ForegroundColor Yellow
  npm ci
}
...
Write-Host "Control activo en 8084; Coordination Hub activo en 9090." -ForegroundColor Green
