...
const server = http.createServer(async (request, response) => {
  ...
  if (request.method === 'GET' && url.pathname === '/health') {
    return send(response, 200, { ok: true, service: 'deliver-assets-sync-hub', revision: state.revision, updatedAt: state.updatedAt, capabilities: ['product-media-v1', 'business-media-v1', 'catalog-v2', 'coordination-v2', 'chat-media-v1', 'receipt-v1', 'rider-chat-v1', 'control-intervention-v1'] })
  }
